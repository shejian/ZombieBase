...
/**
 * Created by Jervis on 2018/6/17.
 * 一个典型的弹窗，可以通过Style做定制
 */
public abstract class DialogBuilder {
    ...
    public static View getSingleMsgViewDebugInfo(Context context, CharSequence msg) {
        View loadView = View.inflate(context, R.layout.ued_dialog_msg_debug, null);
        ((TextView) loadView.findViewById(R.id.message)).setText(msg);
        return loadView;
    }
 ...
 /*   public static AlertDialog showProgressTextHorDialog(Context context, String msg) {
    ...
    public interface SelectedBackEvent {
